    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-24 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-white/70 mb-10 leading-relaxed">
          Hosting a 2026 NBA Finals watch party for Games 5-7 at your NJ venue? Fill out the form below — once approved, your watch party is published on our public page so fans across NJ can find it.
        </p>
