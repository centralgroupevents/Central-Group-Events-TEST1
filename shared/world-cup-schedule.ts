...
// Weeks are Monday-Sunday calendar weeks (week 1 is the partial opener week
// from Thursday Jun 11 to Sunday Jun 14).
export const WORLD_CUP_2026_WEEKS: { index: number; label: string; startDate: string; endDate: string }[] = [
  { index: 1, label: "Week 1: Jun 11-14 (Group stage opener)",    startDate: "2026-06-11", endDate: "2026-06-14" },
  { index: 2, label: "Week 2: Jun 15-21 (Group stage)",           startDate: "2026-06-15", endDate: "2026-06-21" },
  { index: 3, label: "Week 3: Jun 22-28 (Group finals + R32)",    startDate: "2026-06-22", endDate: "2026-06-28" },
  { index: 4, label: "Week 4: Jun 29-Jul 5 (R32 + R16)",          startDate: "2026-06-29", endDate: "2026-07-05" },
  { index: 5, label: "Week 5: Jul 6-12 (QF)",                     startDate: "2026-07-06", endDate: "2026-07-12" },
  { index: 6, label: "Week 6: Jul 13-19 (SF + Third + Final)",    startDate: "2026-07-13", endDate: "2026-07-19" },
];
...
export const WORLD_CUP_2026_SCHEDULE: WorldCupDay[] = [
  // ── Week 1 ────────────────────────────────────────────────────────────────
  { date: "2026-06-11", weekIndex: 1, weekLabel: "Week 1: Jun 11-14 (Group stage opener)", matches: [
    { slot: "2026-06-11-A1", fixture: "Mexico vs Belgium (Group A opener)", stadium: STADIUMS.azteca, timeEt: "12:00 PM ET", stage: "group" },
  ]},
  { date: "2026-06-12", weekIndex: 1, weekLabel: "Week 1: Jun 11-14 (Group stage opener)", matches: [
  ...
  { date: "2026-06-13", weekIndex: 1, weekLabel: "Week 1: Jun 11-14 (Group stage opener)", matches: [
  ...
  { date: "2026-06-14", weekIndex: 1, weekLabel: "Week 1: Jun 11-14 (Group stage opener)", matches: [
  ...
  { date: "2026-06-15", weekIndex: 2, weekLabel: "Week 2: Jun 15-21 (Group stage)", matches: [
  ...
  { date: "2026-06-16", weekIndex: 2, weekLabel: "Week 2: Jun 15-21 (Group stage)", matches: [
  ...
  { date: "2026-06-17", weekIndex: 2, weekLabel: "Week 2: Jun 15-21 (Group stage)", matches: [
  ...
  // ── Week 2 ────────────────────────────────────────────────────────────────
  { date: "2026-06-18", weekIndex: 2, weekLabel: "Week 2: Jun 15-21 (Group stage)", matches: [
  ...
  { date: "2026-06-19", weekIndex: 2, weekLabel: "Week 2: Jun 15-21 (Group stage)", matches: [
  ...
  { date: "2026-06-20", weekIndex: 2, weekLabel: "Week 2: Jun 15-21 (Group stage)", matches: [
  ...
  { date: "2026-06-21", weekIndex: 2, weekLabel: "Week 2: Jun 15-21 (Group stage)", matches: [
  ...
  { date: "2026-06-22", weekIndex: 3, weekLabel: "Week 3: Jun 22-28 (Group finals + R32)", matches: [
  ...
  { date: "2026-06-23", weekIndex: 3, weekLabel: "Week 3: Jun 22-28 (Group finals + R32)", matches: [
  ...
  { date: "2026-06-24", weekIndex: 3, weekLabel: "Week 3: Jun 22-28 (Group finals + R32)", matches: [
  ...
  { date: "2026-06-25", weekIndex: 3, weekLabel: "Week 3: Jun 22-28 (Group finals + R32)", matches: [
  ...
  { date: "2026-06-26", weekIndex: 3, weekLabel: "Week 3: Jun 22-28 (Group finals + R32)", matches: [
  ...
  { date: "2026-06-27", weekIndex: 3, weekLabel: "Week 3: Jun 22-28 (Group finals + R32)", matches: [
  ...
  { date: "2026-06-28", weekIndex: 3, weekLabel: "Week 3: Jun 22-28 (Group finals + R32)", matches: [
  ...
  { date: "2026-07-19", weekIndex: 6, weekLabel: "Week 6: Jul 13-19 (SF + Third + Final)", matches: [
